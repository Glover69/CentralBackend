...
exports.initializeTypingTestSocket = void 0;
const lobby_models_1 = require("../models/lobby.models"); // Ensure this path is correct
const redis_database_1 = require("../../redis-database");
// Generate unique 6-digit lobby code
const generatecode = () => Math.random().toString(36).substring(2, 8).toUpperCase();
const GAME_TICK_MS = 1000;
const initializeTypingTestSocket = (io) => {
    io.of("/typing-test").on("connection", (socket) => {
        ...
        // Create lobby
        socket.on("createLobby", (data) => __awaiter(void 0, void 0, void 0, function* () {
            const code = generatecode();
            //   console.log("here's my data: ", data)
            //   console.log(code, data.playerName, socket.id);
            try {
                const newLobby = new lobby_models_1.LobbyModel({
                    code: code,
        ...
        // Join lobby
        socket.on("joinLobby", (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const lobby = yield lobby_models_1.LobbyModel.findOne({
                    code: data.code
                });
                if (!lobby) {
        ...
        // Player ready up
        socket.on("readyUp", (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const lobby = yield lobby_models_1.LobbyModel.findOne({
                    code: data.code
                });
                ...
                io.of("/typing-test").to(data.code).emit("playerReadyStatusUpdate", {
                ...
                socket.emit("selfReadyStatusConfirmed", {
                    code: data.code,
        ...
        socket.on("startGame", (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const lobby = yield lobby_models_1.LobbyModel.findOne({ code: data.code });
                ...
                yield redis_database_1.redisClient.set(lobbyKey, JSON.stringify(lobbyStructureForRedis));
        ...
        socket.on("updateProgress", (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const key = `lobby:${data.code}`;
                const lobbyData = yield redis_database_1.redisClient.get(key);
                if (!lobbyData) {
                ...
                if (playerIndex !== -1) {
                    ...
                    console.warn(`[updateProgress] Player with ID ${data.id} not found in lobby ${data.code}. Players in Redis:`, lobby.players.map((p) => p.id));
                }
        ...
        socket.on("disconnect", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                ...
                const lobby = yield lobby_models_1.LobbyModel.findOne({ "players.id": socket.id });
                if (!lobby)
                    return;
                ...
                if (lobby.players.length === 0) {
                    yield lobby_models_1.LobbyModel.deleteOne({ _id: lobby._id });
    ...
    function startGameLoop(code) {
        const intervalId = setInterval(() => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Sort leaderboard
                leaderboard.sort((a, b) => b.cursorIndex - a.cursorIndex || b.wpm - a.wpm); // Primary sort by cursor, secondary by WPM
...
exports.initializeTypingTestSocket = initializeTypingTestSocket;
